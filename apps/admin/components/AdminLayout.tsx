...
import { LayoutDashboard, Car, Users, CreditCard, Flag, Store, Megaphone, FileText, LogOut, Menu, X } from 'lucide-react';
    ...
    <div className="min-h-screen bg-cream flex">
      ...
      <aside className={`fixed lg:sticky top-0 left-0 h-screen w-64 bg-navy text-white flex flex-col transform transition-transform z-50 lg:z-auto lg:translate-x-0 ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'}`}>
        ...
        <div className="p-4 border-t border-white/10">
          <Link href="http://localhost:3000" className="flex items-center gap-3 px-4 py-3 rounded-lg text-sm text-gray-300 hover:bg-white/5">
            <LogOut size={18} />
            Back to Site
          </Link>
        </div>
